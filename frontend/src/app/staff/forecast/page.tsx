...
export default function ForecastPage() {
	...
	const generateForecast = () => {
		...
		setTimeout(() => {
			const crowd = parseInt(inputs.crowdExpected, 10) || 200; // FIXED: Added radix parameter
			...
			const slots = [
				{
					...
					description:
						inputs.weather === "rainy"
							? "Hot comfort breakfast with warm beverages"
							: "Energizing breakfast to start the day",
					ingredients: [
						{
							name: "Rice",
							quantity: Math.round(totalRequired.rice * slotDistribution.breakfast * 10) / 10,
							unit: "kg",
						},
						{
							name: "Vegetables",
							quantity: Math.round(totalRequired.vegetables * slotDistribution.breakfast * 10) / 10,
							unit: "kg",
						},
						{
							name: "Milk",
							quantity: Math.round(totalRequired.milk * slotDistribution.breakfast * 10) / 10,
							unit: "l",
						},
						{
							name: "Oil",
							quantity: Math.round(totalRequired.oil * slotDistribution.breakfast * 10) / 10,
							unit: "l",
						},
					],
				...
				},
				{
					...
					ingredients: [
						{
							name: "Rice",
							quantity: Math.round(totalRequired.rice * slotDistribution.lunch * 10) / 10,
							unit: "kg",
						},
						{
							name: "Vegetables",
							quantity: Math.round(totalRequired.vegetables * slotDistribution.lunch * 10) / 10,
							unit: "kg",
						},
						{
							name: "Chicken",
							quantity: Math.round(totalRequired.chicken * slotDistribution.lunch * 10) / 10,
							unit: "kg",
						},
						{
							name: "Spices",
							quantity: Math.round(totalRequired.spices * slotDistribution.lunch * 10) / 10,
							unit: "kg",
						},
						{
							name: "Oil",
							quantity: Math.round(totalRequired.oil * slotDistribution.lunch * 10) / 10,
							unit: "l",
						},
					],
				...
				},
				{
					...
					description:
						inputs.weather === "hot"
							? "Light and refreshing dinner options"
							: "Wholesome dinner to end the day",
					ingredients: [
						{
							name: "Rice",
							quantity: Math.round(totalRequired.rice * slotDistribution.dinner * 10) / 10,
							unit: "kg",
						},
						{
							name: "Vegetables",
							quantity: Math.round(totalRequired.vegetables * slotDistribution.dinner * 10) / 10,
							unit: "kg",
						},
						{
							name: "Chicken",
							quantity: Math.round(totalRequired.chicken * slotDistribution.dinner * 10) / 10,
							unit: "kg",
						},
						{
							name: "Spices",
							quantity: Math.round(totalRequired.spices * slotDistribution.dinner * 10) / 10,
							unit: "kg",
						},
					],
			...
			const ingredientSummary = [
				{
					...
					shortage: Math.max(
						0,
						Math.round((totalRequired.rice - parseFloat(inputs.rice)) * 10) / 10
					),
				},
				{
					name: "Vegetables",
					...
					shortage: Math.max(
						0,
						Math.round((totalRequired.vegetables - parseFloat(inputs.vegetables)) * 10) / 10
					),
				},
				{
					name: "Chicken",
					...
					shortage: Math.max(
						0,
						Math.round((totalRequired.chicken - parseFloat(inputs.chicken)) * 10) / 10
					),
				},
				{
					name: "Spices",
					...
					shortage: Math.max(
						0,
						Math.round((totalRequired.spices - parseFloat(inputs.spices)) * 10) / 10
					),
				},
				{
					name: "Oil",
				...
				},
				{
					...
					shortage: Math.max(
						0,
						Math.round((totalRequired.milk - parseFloat(inputs.milk)) * 10) / 10
					),
				},
			];
			...
			const lowIngredients = ingredientSummary.filter(
				(i) => i.status === "low" || i.status === "critical"
			);

			if (lowIngredients.length > 0) {
				recommendations.push(
					`⚠️ Order ${lowIngredients.map((i) => i.name).join(", ")} immediately to meet demand`
				);
			}
			...
			if (adjustedCrowd > crowd * 1.2) {
				recommendations.push(
					"📈 High demand expected! Ensure adequate staff and seating arrangements"
				);
			}
		...
		<div className={styles.container}>
			...
			<div className={styles.content}>
				...
				<form onSubmit={handleSubmit} className={styles.inputSection}>
					...
					<div className={styles.inputGrid}>
						...
						<div className={styles.inputCard}>
							...
							<div className={styles.inputGroup}>
								<label htmlFor="crowdExpected" className={styles.inputLabel}>
									{" "}
									{/* FIXED: Added htmlFor */}
									<Users size={16} />
									Expected Crowd
								...
								<input
									id="crowdExpected" // FIXED: Added id to match label
									type="number"
									name="crowdExpected"
							...
							<div className={styles.inputGroup}>
								<label htmlFor="weather" className={styles.inputLabel}>
									{" "}
									{/* FIXED: Added htmlFor */}
								...
								<select
									id="weather" // FIXED: Added id to match label
									name="weather"
							...
							<div className={styles.inputGroup}>
								<label htmlFor="dayType" className={styles.inputLabel}>
									{" "}
									{/* FIXED: Added htmlFor */}
									<Calendar size={16} />
									Day Type
								...
								<select
									id="dayType" // FIXED: Added id to match label
									name="dayType"
						...
						<div className={styles.inputCard}>
							...
							<div className={styles.ingredientGrid}>
								<div className={styles.inputGroup}>
									<label htmlFor="rice" className={styles.inputLabel}>
										Rice (kg)
									</label>{" "}
									{/* FIXED: Added htmlFor */}
									<input
										id="rice" // FIXED: Added id to match label
										type="number"
										name="rice"
										value={inputs.rice}
										onChange={handleInputChange}
								...
								<div className={styles.inputGroup}>
									<label htmlFor="vegetables" className={styles.inputLabel}>
										Vegetables (kg)
									</label>{" "}
									{/* FIXED: Added htmlFor */}
									<input
										id="vegetables" // FIXED: Added id to match label
										type="number"
										name="vegetables"
								...
								<div className={styles.inputGroup}>
									<label htmlFor="chicken" className={styles.inputLabel}>
										Chicken (kg)
									</label>{" "}
									{/* FIXED: Added htmlFor */}
									<input
										id="chicken" // FIXED: Added id to match label
										type="number"
										name="chicken"
								...
								<div className={styles.inputGroup}>
									<label htmlFor="spices" className={styles.inputLabel}>
										Spices (kg)
									</label>{" "}
									{/* FIXED: Added htmlFor */}
									<input
										id="spices" // FIXED: Added id to match label
										type="number"
										name="spices"
										value={inputs.spices}
										onChange={handleInputChange}
								...
								<div className={styles.inputGroup}>
									<label htmlFor="oil" className={styles.inputLabel}>
										Oil (l)
									</label>{" "}
									{/* FIXED: Added htmlFor */}
									<input
										id="oil" // FIXED: Added id to match label
										type="number"
										name="oil"
										value={inputs.oil}
										onChange={handleInputChange}
								...
								<div className={styles.inputGroup}>
									<label htmlFor="milk" className={styles.inputLabel}>
										Milk (l)
									</label>{" "}
									{/* FIXED: Added htmlFor */}
									<input
										id="milk" // FIXED: Added id to match label
										type="number"
										name="milk"
										value={inputs.milk}
										onChange={handleInputChange}
					...
					<button type="submit" className={styles.forecastButton} disabled={isLoading}>
						<TrendingUp size={24} />
