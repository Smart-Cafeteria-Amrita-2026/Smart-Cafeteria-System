...
import { SlotList } from '@/features/bookings/components/SlotList';
import { useBookingStore } from '@/stores/booking.store';
import { MealType } from '@/features/bookings/types/booking.types';
...
export default function SlotsPage() {
    return (
        <Suspense fallback={<div className="p-8 text-center text-gray-500">Loading booking flow...</div>}>
            <SlotsPageContent />
        </Suspense>
    );
}
