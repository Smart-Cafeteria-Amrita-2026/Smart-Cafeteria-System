      ...
      <div className={styles.content}>
        <div className={styles.header}>
          ...
          <div className={styles.actionButtons}>
            <button onClick={toggleForecastPanel} className={`${styles.button} ${styles.forecastButton}`}>
              📊 Forecasting
            </button>
            <button onClick={openCreateSlotModal} className={`${styles.button} ${styles.createButton}`}>
              ➕ Create Meal Slot
            </button>
            <button 
        ...
        <div className={styles.dateSection}>
          <h2 className={styles.dateTitle}>
            Today's Slots - {mounted ? new Date().toLocaleDateString('en-US', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' }) : 'Loading...'}
          </h2>
        </div>
