    ...
    <div className={`${styles.card} ${active ? styles.active : ''}`}>
      <div className={styles.cardHeader}>
        <div className={styles.mealType}>
          <span className={styles.mealIcon}>
            {mealType === 'BREAKFAST' ? '🥐' : mealType === 'LUNCH' ? '🍱' : mealType === 'SNACKS' ? '🥪' : '🍛'}
          </span>
      ...
      <div className={styles.capacityInfo}>
        ...
        <div className={styles.capacityItem}>
          ...
          <span className={`${styles.status} ${active ? styles.activeStatus : styles.inactiveStatus}`}>
      ...
      {active && (
        <button className={styles.viewQueueButton}>👁️ View Queue</button>
      )}
    </div>
  );
}