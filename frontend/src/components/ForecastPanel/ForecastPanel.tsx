			...
			>
				<div className={styles.panelHeader}>
					...
					<button
						...
						onKeyDown={(e) => handleKeyDown(e, toggleForecastPanel)}
					>
						×
					</button>
				</div>
					...
					<div className={styles.section}>
						...
						<div className={styles.paramGrid}>
							<div className={styles.paramCard}>
								...
								<div className={styles.paramValue}>{forecastData.currentParam}%</div>
							</div>
							<div className={styles.paramCard}>
								<div className={styles.paramLabel}>Seats in Canteen</div>
								<div className={styles.paramValue}>{forecastData.seatsInCanteen}</div>
							</div>
							<div className={styles.paramCard}>
								<div className={styles.paramLabel}>Time per Meal Slot</div>
								<div className={styles.paramValue}>{forecastData.timePerMealSlot} min</div>
							</div>
						</div>
					</div>
