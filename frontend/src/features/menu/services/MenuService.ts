...
export const MenuService = {
    getMenuItems: async (mealType: string): Promise<MenuItem[]> => {
        try {
            ...
            switch (mealType) {
                case 'breakfast': return mapToMenuItem(breakfastMenu, 'breakfast');
                case 'lunch': return mapToMenuItem(lunchMenu, 'lunch');
                case 'snacks': return mapToMenuItem(snacksMenu, 'snacks');
                case 'dinner': return mapToMenuItem(dinnerMenu, 'dinner');
                default: return [];
            }
        }
    }
