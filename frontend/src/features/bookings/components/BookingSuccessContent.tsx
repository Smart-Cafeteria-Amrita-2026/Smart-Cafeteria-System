        ...
        <div className="space-y-6">
            ...
            <div className="bg-blue-50 border border-blue-100 rounded-2xl p-4 flex items-center gap-4">
                <div className="flex-1">
                    <p className="text-xs text-blue-600 font-bold uppercase tracking-wider mb-1">Queue Info</p>
                    <p className="text-sm text-blue-800 font-medium">Please proceed to **Counter 2** when your token appears on the screen.</p>
                </div>
